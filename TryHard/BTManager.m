...
//{
//    static BTManager* bluetoothManager = nil;
//    static dispatch_once_t onceToken;
//    dispatch_once(&onceToken, ^{
//        
//        libHandle = dlopen("/System/Library/PrivateFrameworks/BluetoothManager.framework/BluetoothManager", RTLD_NOW);
//        BluetoothManager* bm = [BTManager bluetoothManagerSharedInstance];
//        
//        bluetoothManager = [[BTManager alloc] init];
//    });
...
//    
//    BTDevice *bluetoothDevice = [[BTDevice alloc] initWithBluetoothDevice: notification.object];
